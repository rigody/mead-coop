 ...
 * @property User $super0
 * @property User $under0
 */
class Hierarchy extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('super, under', 'required'),
			array('super, under', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, super, under', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'relSuper' => array(self::BELONGS_TO, 'User', 'super'),
			'relUnder' => array(self::BELONGS_TO, 'User', 'under'),
		);
	}
